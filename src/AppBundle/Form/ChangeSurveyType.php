 ...
 * @author sagar
 */
class ChangeSurveyType extends AbstractType
{
//    private $questions;
    
    public function buildForm(FormBuilderInterface $builder, array $options) {
        $questions = $options['questions'];
        $builder->add('change', AmpedTextareaType::class, array('label'=>'What is the change you are considering? Write it here: '));
